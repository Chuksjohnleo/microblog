...
export default function Learning({posts}) {
  ...
  return (
    <>
      <Head>
        <title>Learning | Chuksjohnleo Blogs</title>
        <meta name="description" content="Learning posts on Chuksjohnleo" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon_io/favicon.ico" />
      </Head>
     <HomeLayout path={"Learning"}>
      <h1 className={styles.h1}>Learning Category</h1>
