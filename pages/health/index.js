...
export default function Health({posts}) {
  ...
  return (
    <>
      <Head>
        <title>Health | Chuksjohnleo Blogs</title>
        <meta name="description" content="Health posts on Chuksjohnleo" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon_io/favicon.ico" />
      </Head>
      <HomeLayout path={"Health"}>
       <h1 className={styles.h1}>Health Category</h1>
