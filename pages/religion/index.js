...
export default function Religiont({posts}) {
  
  return (
    <>
      <Head>
        <title>Religion | Chuksjohnleo Blogs</title>
        <meta name="description" content="Religion posts on Chuksjohnleo" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon_io/favicon.ico" />
      </Head>
      <HomeLayout path={"Religion"}>
      <h1 className={styles.h1}>Religion Category</h1>
